                    ...
                    <div className="flex flex-col text-center py-28 gap-6">
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="text-lg text-slate-200">
                                Захватывающая игра в жанре ММОРПГ, которая
                                перенесёт вас в удивительный фэнтезийный мир,
                                полный опасностей и приключений. В этой игре вы
                                сможете создать своего уникального персонажа,
                                выбрать его класс и отправиться в незабываемое
                                приключение, сражаясь с остальными игроками.
                            </p>
                        </div>
